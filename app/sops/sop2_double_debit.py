...
def node_transaction_verification(state: Sop2State) -> Sop2State:
...
def node_create_ticket(state: Sop2State) -> Sop2State:
...
def node_process_additional_prompt(state: Sop2State) -> Sop2State:
...
def gate_entry_routing (state: Sop2State) -> str:
	entry_step: STEPS
...
def gate_is_early_exit (state: Sop2State) -> bool:
